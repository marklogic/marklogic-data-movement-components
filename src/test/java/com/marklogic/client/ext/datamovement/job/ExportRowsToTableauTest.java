...
public class ExportRowsToTableauTest extends AbstractDataMovementTest {
  ...
  private String datasource = "src/test/resources/";
  ...
  public void testGenerateTableauFile() throws Exception {
    ...
    QueryBatcher qb = moveMgr.newQueryBatcher(query)
        .onUrisReady(new ExtractViaTemplateListener()
      ...
      try {
        ...
        if ( tableauWriter3 != null ) {
          ...
          try {
            ...
            logger.info("Exceptions thrown during ExtractViaTemplateListener 3 close.");
            e.printStackTrace();
          }
        }
        if ( tableauWriter4 != null ) {
          ...
          try {
            ...
            logger.info("Exceptions thrown during ExtractViaTemplateListener 4 close.");
            e.printStackTrace();
          }
        }
      }
